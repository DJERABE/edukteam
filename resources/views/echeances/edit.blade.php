...
@section('body')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Echéance de payement</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Accueil</a></li>
                    <li class="breadcrumb-item">Echéance de payement</li>
                <a href="{{ route('echeances.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Liste Echéance de payement</a>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Modifier Echéance de payement</h4>
                </div>
                <div class="card-body">
                    {!! Form::model($echeance, ['method' => 'PUT', 'route' => ['echeances.update',  $echeance->id ] ]) !!}
                        <div class="form-body">
                            @include('echeance._form')
                        </div>
