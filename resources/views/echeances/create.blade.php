...
@section('title', 'Articles de frais')
        ...
        <div class="col-lg-12" style="margin: auto;">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Echéance de payement</h4>
                </div>
                  <div class="card-body">
                    {!! Form::open( ['method' => 'post', 'url' => route('echeances.store')]) !!}
                        <div class="form-body">
                            @include('echeances._form')
                        </div>
