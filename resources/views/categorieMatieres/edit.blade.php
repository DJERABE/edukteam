        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">>Categorie Matière</li>
                <a href="{{ route('categorieMatieres.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Liste Categorie Matière</a>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Modifier >Categorie Matière</h4>
                </div>
                <div class="card-body">
                    {!! Form::model($categorieMatiere, ['method' => 'PUT', 'route' => ['categorieMatieres.update',  $categorieMatiere->id ] ]) !!}
                        <div class="form-body">
                            @include('categorieMatieres._form')
                        </div>
