...
@section('title', 'Frais de configuration')
...
@section('body')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">> Frais de configuration</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Accueil</a></li>
                    <li class="breadcrumb-item">>  Frais de configuration</li>
                <a href="{{ route('frais_configs.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Liste Frais de Configurations</a>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Modifier > Frais de configuration</h4>
                </div>
                <div class="card-body">
                    {!! Form::model($fraisConfig, ['method' => 'PUT', 'route' => ['frais_configs.update',  $fraisConfig->id ] ]) !!}
                        <div class="form-body">
                            @include('frais_configurations._form')
                        </div>
