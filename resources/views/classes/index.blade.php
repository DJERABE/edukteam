    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                @can('add_classes')
                    <a href="{{ route('classes.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Nouvelle classe</a>
                @endcan
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $classe->name }}</td>
                                    <td>{{ $classe->study_level->name }}</td>
                                    <td>{{ $classe->school->nom }}</td>
                                <td>{{$classe->students->count()}}/{{ $classe->student_effectif }}</td>
                                    <td>
