...
@section('body')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Sessions</h4>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Infos session</h4>
                </div>
                <div class="card-body">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ date('d/m/Y', strtotime($session->start)) }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">Fin</label>
                                    <input type="text" class="form-control" value="{{ date('d/m/Y', strtotime($session->end)) }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $session->academic_year->name }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">Etablissement</label>
                                    <input type="text" class="form-control" value="{{ $session->school->nom }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
