    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('matieres.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Liste Matière</a>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Modifier > Matière</h4>
                </div>
                <div class="card-body">
                    {!! Form::model($matiere, ['method' => 'PUT', 'route' => ['matieres.update',  $matiere->id ] ]) !!}
                        <div class="form-body">
