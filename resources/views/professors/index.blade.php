    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                @can('add_professors')
                    <a href="{{ route('professors.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Nouveau professeur</a>
                @endcan
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $professor->nom }}</td>
                                    <td>{{ $professor->prenoms }}</td>
                                    <td>{{ $professor->contact_1 }} @if(!empty($professor->contact_2)) {{ ' / '.$professor->contact_2 }} @endif</td>
                                    <td>{{ $professor->subjects->implode('name', ', ') }}</td>
                                    <td>{{ $professor->school->nom }}</td>
                                    <td>
