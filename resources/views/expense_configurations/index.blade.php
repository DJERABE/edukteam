        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Configurations de frais</li>
                </ol>
                            ...
                            <div class="row">  
                                    {{-- <div class="col-md-4">
                                        <div class="form-group @if ($errors->has('school')) has-danger @endif">
                                            ...
                                            <select class="select2 form-control @if ($errors->has('school')) form-control-danger @endif custom-select select2-hidden-accessible" style="width: 100%; height:36px;" tabindex="-1" aria-hidden="true" name="annee" id=""> 
                                                <option value="{{ $academique->id }}" @if( isset($fraisConfig->school) && !empty($fraisConfig->school) && $academique->id == $fraisConfig->school->id ) {{ ' selected' }} @endif >{{ $academique->name }}</option> 
                                            </select>
