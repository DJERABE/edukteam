{{-- <script>
    $( document ).ready(function() { 
        ...
        $('#annee').on('change', function(e){
            ...
            if(annee_id) {
                $.get('/api/get/'+ annee_id , function(data) {
        ...
        $('#echeance').on('change', function(e){

            var school_id =  document.getElementById ('school').value ;
            var classe_id = document.getElementById ('classe').value ;
            var echeance_id = document.getElementById ('echeance').value ;

            //alert('school_id='+school_id+'class_id='+classe_id+'echeance_id='+echeance_id)

            if(classe_id,school_id,echeance_id) {
                $.get('/api/getfacture/'+school_id +'/'+classe_id+'/'+echeance_id , function(data) { 
                        if(data) { 
                            $('#etudiant-form-group').show();
                            $('#etudiant').empty();
                            $('#etudiant').append('<option value="{{ old('etudiant_id') }}">---</option>');   
