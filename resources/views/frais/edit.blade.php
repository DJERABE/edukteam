        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Articles de frais</li>
                <a href="{{ route('frais.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Liste Articles de frais</a>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Modifier Articles de frais</h4>
                </div>
                <div class="card-body">
                    {!! Form::model($frai, ['method' => 'PUT', 'route' => ['frais.update',  $frai->id ] ]) !!}
                        <div class="form-body">
                            @include('frais._form')
                        </div>
