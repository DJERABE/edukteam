...
@section('body')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Famile</h4>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::open( ['method' => 'post', 'url' => route('recherchefamille.stor')]) !!}
                        <div class="form-body"> 
                            <div class="row">  
                                <div class="col-md-6"> 
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group @if ($errors->has('name')) has-danger @endif"> 
                                        <input type="text" name="name" class="form-control @if ($errors->has('name')) form-control-danger @endif" placeholder="Recherche nom de famille " required>
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach($datas as $family)
                                <tr>
                                    <td>{{ $family->name }}</td>
                                    <td>{{ $family->code_family }}</td>
