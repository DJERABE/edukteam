    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                @can('add_inscriptions')
                    <a href="{{ route('inscriptions.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Nouvelle inscription</a>
                @endcan
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                        <td>{{ $inscription->student->last_name }} {{ $inscription->student->given_names }}</td>
