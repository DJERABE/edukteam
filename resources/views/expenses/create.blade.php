...
@section('body')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Frais</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('expenses.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Liste frais</a>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12" style="margin: auto;">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Nouveau frais</h4>
                </div>
                  <div class="card-body">
                    {!! Form::open( ['method' => 'post', 'url' => route('expenses.store')]) !!}
                        <div class="form-body">
