    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                @can('add_users')
                    <a href="{{ route('users.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Nouveau compte</a>
                @endcan
            </div>
        </div>
    </div>
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $user->nom }}</td>
                                    <td>{{ $user->prenoms }}</td>
                                    <td>{{ $user->contact_1 }} @if(!empty($user->contact_2)) {{ ' / '.$user->contact_2 }} @endif</td>
                                    <td>{{ $user->email }}</td>
