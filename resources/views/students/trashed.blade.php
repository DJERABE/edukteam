                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endforeach</td>
                                <td>
                                    {!! Form::open( ['method' => 'delete', 'url' => route('students.restore', $student->id), 'style' => 'display: inline', 'onSubmit' => 'return confirm("Êtes-vous sur de vouloir restaurer cet element ?")']) !!} 
                                {{--     @can('view_students')
                                    <a class="btn btn-info btn-sm" href="{{ route("students.restoreShow", $student->id) }}"><i class="fa fa-eye"></i></a>
                                    @endcan --}}

                                 

                                    @can('delete_students')
                                    <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-refresh"></i></button>
                                    @endcan
                                    {!! Form::close() !!}
                                </td>
                            </tr>
