        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Recherche élève</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $class_student->student->last_name }}</td>
                                    <td>{{ $class_student->student->given_names }}</td>
                                    <td>{{ $class_student->classe->study_level->name }}</td>
                                    <td>{{ $class_student->classe->name }}</td> 
                                    <td>
                                        @include('components._actions', [
                                            'entity' => 'students',
                                            'id' => $class_student->student->id
                                        ])
                                    </td> 
                                </tr>
                                @endforeach
