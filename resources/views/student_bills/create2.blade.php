    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open( ['method' => 'post', 'url' => route('student_bills.store')]) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Ecole</label>
                                        <input type="text" value="{{ $school->nom }}" class="form-control" readonly>
                                        <input name="school" value="{{ $school->id }}" hidden>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Année academique</label>
                                        <input type="text" value="{{ $academic_year->name }}" class="form-control" readonly>
                                        <input name="academic_year" value="{{ $academic_year->id }}" hidden>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="classe" value="{{ $classe->id }}" hidden>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="">Eleve</label>
                                        <input type="text" value="{{ $student->last_name }} {{ $student->given_names }}" class="form-control" readonly>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach($expense_configurations->sortBy('echeance') as $expense)
                                                <tr>
                                                    ...
                                                    {{-- <td><input type="checkbox" class="form-control" value="{{ $expense->id }}" min="0" max="1" name="quantite[]"></td> --}}
                                                    <td><input type="number" class="form-control" value="0" min="0" max="1" name="quantite[]"></td>
                                                    <td><input type="number" class="form-control" name="remise[]" min="0" value="0" step="0.01"></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
